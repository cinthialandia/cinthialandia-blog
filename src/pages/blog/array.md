...
```js
const arrayTbbt = ["Penny", "Sheldon" , "Leonard", "Amy", "Howard", "Raj", "Bernadette"]
...
```js
const arraySeries = [ ["Penny", "Sheldon" , "Leonard", "Amy", "Howard", "Raj", "Bernadette"],  ["House", "Wilson" , "Cameron", "Chase", "Foreman", "Cuddy"],  ["Walter", "Jessie" , "Gus", "Hank", "Skyler", "Saul", "Marie"] ]
...
```js
const arrTahm = ["Charlie", "Alan", "Jake", "Walden", "Judith", "Berta", "Evelyn"]
arrTahm.splice(0, 1)
