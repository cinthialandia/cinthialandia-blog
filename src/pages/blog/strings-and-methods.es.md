...
function hola(nombre) {
  console.log("Hola y bienvenido a tu perfil".concat(" ", nombre, " ","que tengas un lindo día" ))
}
...
```js
function hola(nombre) {
  console.log("Hola y bienvenido a tu perfil" + " " + nombre +  " " + "que tengas un lindo día")
}
...
```js
const oracion = 'Oops I did it again I played with your heartgot lost in the game Oh baby baby Oops you think Im in love That Im sent from above Im not that innocent';

const palabra = 'carlos';
const palabra1 = 'baby';

console.log(`La palabra "${palabra}" ${oracion.includes(palabra) ? 'esta' : 'no esta'} en la oracion`); // false
console.log(`La palabra "${palabra1}" ${oracion.includes(palabra1) ? 'esta' : 'no esta'} en la oracion`); // true
